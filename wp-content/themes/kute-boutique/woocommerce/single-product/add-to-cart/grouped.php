...
<form class="cart" method="post" enctype='multipart/form-data'>
	<table cellspacing="0" class="group-product table">
		<tbody>
			<tr>
	            <th><?php esc_html_e('Product name','kute-boutique');?></th>
	            <th class="th-price"><?php esc_html_e('Price','kute-boutique');?></th>
	            <th class="th-qty"><?php esc_html_e('Qty','kute-boutique');?></th>
	        </tr>
			<?php
