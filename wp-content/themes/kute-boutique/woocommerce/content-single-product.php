...
$kt_woo_single_layout = kt_option('kt_woo_single_layout','left');
$single_col_left = 'col-sm-12 col-md-5';
$single_col_right = 'col-sm-12 col-md-7';
if( $kt_woo_single_layout == "full"){

	$single_col_left = 'col-sm-5 col-md-4';
	$single_col_right = 'col-sm-7 col-md-8';
}
?>
